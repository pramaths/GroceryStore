...
docker-compose up
## It handles all the edge cases and I mentioned those in video few things like unique name and distinctive names one more no modification is handled by key words like unique,immutable etc
